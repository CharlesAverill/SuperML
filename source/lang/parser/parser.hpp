...
/**
 ** \file source/lang/parser/parser.hpp
...
#ifndef YY_YY_SOURCE_LANG_PARSER_PARSER_HPP_INCLUDED
# define YY_YY_SOURCE_LANG_PARSER_PARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 8 "source/lang/parser/parser.y"
...
#line 68 "source/lang/parser/parser.hpp"
...
namespace MC {
#line 209 "source/lang/parser/parser.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    FALSE = 268,                   // FALSE
    INTLIT = 269,                  // INTLIT
    FLOATLIT = 270,                // FLOATLIT
    STRINGLIT = 271,               // STRINGLIT
    UNIT = 272,                    // UNIT
    BOOL = 273,                    // BOOL
    INT = 274,                     // INT
    FLOAT = 275,                   // FLOAT
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_FALSE = 13,                            // FALSE
        S_INTLIT = 14,                           // INTLIT
        S_FLOATLIT = 15,                         // FLOATLIT
        S_STRINGLIT = 16,                        // STRINGLIT
        S_UNIT = 17,                             // UNIT
        S_BOOL = 18,                             // BOOL
        S_INT = 19,                              // INT
        S_FLOAT = 20,                            // FLOAT
        ...
        S_term = 26,                             // term
        S_app_term = 27,                         // app_term
        S_simple_term = 28,                      // simple_term
        S_atom = 29,                             // atom
        S_type = 30,                             // type
        S_arrow_type = 31,                       // arrow_type
        S_tuple_type = 32,                       // tuple_type
        S_base_type = 33                         // base_type
      };
    };
...
switch (yykind)
    {
      ...
      {
        return MC_Parser::symbol_name (this->kind ());
      }
#endif // #if YYDEBUG || 0
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::YYEOF
                   || (token::YYerror <= tok && tok <= token::FALSE)
                   || (token::UNIT <= tok && tok <= token::STRING)
                   || tok == 61);
#endif
      }
#if 201103L <= YY_CPLUSPLUS
...
#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    MC_Parser (const MC_Parser&) = delete;
    /// Non copyable.
    MC_Parser& operator= (const MC_Parser&) = delete;
#endif
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::INTLIT, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::INTLIT, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_FLOATLIT (float v, location_type l)
      {
        return symbol_type (token::FLOATLIT, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_FLOATLIT (const float& v, const location_type& l)
      {
        return symbol_type (token::FLOATLIT, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_STRINGLIT (std::string v, location_type l)
      {
        return symbol_type (token::STRINGLIT, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::STRINGLIT, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#line 1638 "source/lang/parser/parser.hpp"




#endif // !YY_YY_SOURCE_LANG_PARSER_PARSER_HPP_INCLUDED
